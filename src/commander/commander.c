...
/*   Updated: 2022/10/11 10:50:51 by yoav             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "commander.h"

t_error_code	commander_init_cmd(t_dll **node, t_cmd *c)
{
	t_dll			*n;
	t_token			*t;
	t_error_code	err;
...
t_error_code	commander_init_all_cmds(t_cmd_list *cmd_lst, \
...
int	add_envp(t_dll *elem, void *param)
{
	t_cmd	*c;
